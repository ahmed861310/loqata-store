...
$("accountForm")?.addEventListener('submit',e=>{e.preventDefault();customer={...customer,name:$('accountName').value.trim(),phone:$('accountPhone').value.trim(),address:$('accountAddress').value.trim()};saveCustomer();if($("customerName"))$("customerName").value=customer.name||"";if($("customerPhone"))$("customerPhone").value=customer.phone||"";if($("customerAddress"))$("customerAddress").value=customer.address||"";toast('تم حفظ بيانات التواصل على هذا الجهاز');});
